...
var displaymap = function displaymap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhhcm1hIiwiYSI6ImNrbnNuZm1majEwMDcyb3F3aWhweTl3NGgifQ.V-7Fy_9TRM6Hn6mshKQ3tA';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Check your entered data');
...
exports.changeUserPhoto = exports.updateSetting = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Please provide valid data');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IjpqxSCBrmVKbatVl2XPccKtPpv8f0hAPeY9YODoaSJt2ZgLeND3iJMxvvxmAw7nWVsy3N7FkdSnn9kQCWI6JIw00RfKgIBdu'); // 1) Get checkout session from API

            _context.next = 4;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/booking/checkout/".concat(tourId));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return (0, _updateSetting.changeUserPhoto)(form);
